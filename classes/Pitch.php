...
class Pitch extends CompoObject {

	private $step;
	private $alter;
	private $octave;	
	static $availableComponents = array('step' => 'step', 
																			'alter' => 'semitones',
																			'octave' => 'octave');
static $availableOptions = array();
	...
	function __construct($components, $options = array())
	{
		...
		$this->check();
		$this->step = $this->components['step'];
		$this->alter = isset($this->components['alter']) ? $this->components['alter'] : 0;
		$this->octave = $this->components['octave'];
	}
